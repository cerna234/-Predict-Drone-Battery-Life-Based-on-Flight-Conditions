...
model = load(fr'C:\Users\Miguel Cerna\OneDrive\Desktop\-Predict-Drone-Battery-Life-Based-on-Flight-Conditions\Regressor\drone-battery-life-regression-pipeline.joblib')  # 
...
sample_input = [['RQ-11 Raven',-20,3,0,37.4,3,'surveillance',0.1,344,0,0,3]] 
